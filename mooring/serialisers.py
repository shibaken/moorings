...
class BookingSerializer(NH3SanitizeSerializerMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = ('id','legacy_id','legacy_name','arrival','departure','details','cost_total','override_price','override_reason','override_reason_info','mooringarea','campground_name','campground_region','campground_site_type','campsites','invoices','is_canceled','guests','regos','vehicle_payment_status','refund_status','amount_paid','created')
